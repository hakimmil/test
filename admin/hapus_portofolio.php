...
?>
 ...
 <div class="box box-primary">
        <form role="form" name="formresume" method="POST" enctype="multipart/form-data" action="<?= 'aksi.php?module=portofolio&act=hapus'?>">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Waktu" name="waktu" value="<?= $row['waktu'];?>" disabled>
            </div>
            <div class="form-group">
              <label for="exampleInputEmail1">Foto</label>
              <input type="file" id="exampleInputFile" name="foto" disabled>
            </div>
          </div>
